...
export default class Danh_sach_Iphone extends Component{
    static navigationOptions = ({navigation}) =>{
        let tabBarLabel= "Iphone";
        let tabBarIcon=()=>(
            <Image 
    ...
    componentDidMount() {
        ...
        .then((responseData) => {
            let dsIphone = responseData.filter(item => {return item.Nhom_Dien_thoai.Ten == 'iphone'});
            this.setState({dsDienThoai:dsIphone});
        })
        .catch((error) => {
            console.log(error);
